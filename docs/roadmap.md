...
binding surface.
Current Milestone D contract closeout prep is recorded in
[`docs/validation/milestone-d-contract-closeout-prep-2026-06-19.md`](validation/milestone-d-contract-closeout-prep-2026-06-19.md);
final D exit still requires review, merge to `main`, and a fresh validation run.
