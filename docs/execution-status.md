...
- Native Ethos verification can emit deterministic crop descriptor JSON artifacts through `--crop-dir`; these bind `document_fingerprint`, page, bbox, and check ids, but they are not rendered image crops yet.
