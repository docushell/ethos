...
| V4 | fingerprint manifest of `schemas/examples/document.example.json` (its embedded hashes are real — regenerated by the reference implementation) | (see §6 manifest with the example's hashes) | `6a5405cdfd34367aeb54440f90bdd59e501f7aff6b4d3fb000a5d4d14379b6ed` |
