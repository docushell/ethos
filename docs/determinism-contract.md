...
| V4 | fingerprint manifest of `schemas/examples/document.example.json` (its embedded hashes are real — regenerated by the reference implementation) | (see §6 manifest with the example's hashes) | `575623b28349dda9fbc4746b305048ed1ac692a50365ac9bc6a21a7ceeba8755` |

Profile artifact pin: sha256(c14n(`profiles/ethos-deterministic-v1.json`)) =
`eaf73db8113d2138f9e806f13a5a33649f3e7b67b4a87489909c396565ad092a` (asserted in
