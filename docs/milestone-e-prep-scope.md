...
It binds the accepted package tag names to activated main commit `421bed8` / tree
`aa0d5d31d879540fd0044052dfeb747f12b64204`; package tag creation remains blocked, operator
evidence remains required, and public installation remains blocked.
...
It records manual crates.io owner/account evidence requirements, reserved-name confirmation,
...
It provides the exact non-secret output packet required from the operator for crates.io
