...
| NIP-1.7 | P0 | blocked | 0.5 | NIP-1.4, NIP-1.5, NIP-1.6 | 2026-07-20 | `docs/validation/nip-1-docushell-integration-closeout-2026-07-20.md` | Closeout packet prepared with source bindings, commands, real acceptance, and all friction dispositions; decider review is the only remaining gate. |
