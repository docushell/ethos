...
| NIP-3.2 | P0 | blocked | 1 | NIP-3.1 | 2026-07-20 | `../ethos-bench/benchmarks/trust/judges.lock.json`; `../ethos-bench/src/ethos_bench/trust_judges.py` | Engineering complete: dated frontier/small snapshots, fixed prompt, N=5 × 20 documents, offline double-run, latency/token/cost capture, and pre-request cost ceiling pass; live 200-call run awaits explicit spend approval. |
