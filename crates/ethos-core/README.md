...
already labeled question relevance, synthesis, and claim support. That helper builds the
non-canonical app answer release envelope documented in `docs/app-answer-release-contract.md`; it
does not replace `verification_report.json`, does not judge those labels itself, and rejects
duplicate claim IDs before building release lists.
