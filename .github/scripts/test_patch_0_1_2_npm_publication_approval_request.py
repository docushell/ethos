...
RECORD = ROOT / "docs/validation/patch-0-1-2-npm-publication-approval-request-validation-2026-06-24.md"
VALIDATION_README = ROOT / "docs/validation/README.md"

SOURCE_SHORT = "8ee8e8c"
SOURCE_COMMIT = "8ee8e8c5b6f4fb228f896b7e3e336f17b560490c"
SOURCE_TREE = "959115a414e334a42f0078b2070e9790eb5b752f"
...
class Patch012NpmPublicationApprovalRequestTests(unittest.TestCase):
    ...
    def test_request_names_exact_candidate_and_evidence(self) -> None:
        ...
        for expected in (
            ...
            "patch-0-1-2-npm-vendor-refresh-validation-2026-06-24.md",
            "patch-0-1-2-artifact-publication-closeout-validation-2026-06-24.md",
        ):
    ...
    def test_record_is_indexed(self) -> None:
        ...
        self.assertIn("patch 0.1.2 npm publication approval request", readme.lower())
