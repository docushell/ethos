...
class MilestoneEPackagePublicationCandidateActivationEvidenceTests(unittest.TestCase):
    ...
    def test_source_candidate_manifests_are_activated_and_profile_copy_is_in_sync(self) -> None:
        ...
        self.assertIn('publication_status = "approved_for_crates_io_publication"', core_manifest)
        self.assertIn('publication_status = "approved_for_crates_io_publication"', verify_manifest)
        self.assertIn('publication_status = "approved_for_crates_io_publication"', pdf_manifest)
